    ...
    public ModelView getResponse(String className, String methodName,HttpServletRequest req) throws Exception {
        ...
        for (File file : files) {
            if (file.getName().compareTo(className.concat(".class")) == 0) {
                ...
                Object instance = employerClass.newInstance();
                ...
                if (employerClass != null) {
                    ...
                    Field[] fields = employerClass.getDeclaredFields();
                    ...
                    for (Map.Entry<String, String[]> entry : params.entrySet()) {
                        ...
                        for (Field field : fields) {
                            ...
                            if(paramName.compareToIgnoreCase(fieldName)==0){
                                ...
                                setterMethod = employerClass.getMethod(setterMethodName,fieldType);
                    ...
                    if (findMethod != null) {
                        // prendre tout les valeurs dans le getAttribute et le mettre dans
                        try {
                            Object result = findMethod.invoke(instance);
